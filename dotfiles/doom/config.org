...
Keep my =org-roam= files somwhere else.
#+begin_src emacs-lisp :tangle yes
...
One it is installed we need to tell Emacs to use it.
#+begin_src emacs-lisp :tangle yes
(setq ispell-dictionary "en-custom")

#+end_src

If I add any words of my own (e.g., technical terms) then they will be saved to my personal dictionary. As I will probably want to share it with the different devices I use, I keep it in a slightly-odd-but-works-for-me place.
