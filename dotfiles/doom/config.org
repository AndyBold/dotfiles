* My /n/th literal emacs configuration     :TOC_3:
  ...
  - [[#orgmode-1][Orgmode]]
    - [[#improve-agenda-and-capture][Improve Agenda and Capture]]
...
=org-download= allows me to drag and drop images directly into an Org document.
#+begin_src emacs-lisp
...
=org-toc= will auto-generate a Table of Contents when a header has the right tag. You can see it's output at the top of this very file.
#+begin_src emacs-lisp
(use-package! toc-org
  :after org-mode)
#+end_src
...
** Orgmode
Don't be a laggard - use the most recent version of orgmode.
#+begin_src emacs-lisp :tangle yes
(unpin! org)
...
*** Improve Agenda and Capture
Install super-agenda.
